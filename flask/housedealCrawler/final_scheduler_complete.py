...
from avg_price_updater import AvgPriceUpdater
...
class CompleteHouseScheduler:
    ...
    def __init__(self, api_key: str, db_config: dict, email_config: dict = None):
        ...
        self.latest_deals_updater = LatestHouseDealsUpdater(db_config)  # ✅ 새로 추가
    ...
    def _update_all_tables_after_collection(self):
        ...
        try:
            ...
            try:
                latest_result = self.latest_deals_updater.update_latest_housedeals()
